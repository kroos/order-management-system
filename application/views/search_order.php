...
<table border="0" width="100%" cellpadding="2">
	<tr>
		<td>Client Name : </td>
		<td><?=form_dropdown('client', $h, set_value('client'))?><?=form_error('client')?></td>
	</tr>
	<tr>
		<td>Date</td>
		<td>
		...
		<table border="0" width="100%" cellpadding="2">
			<tr>
				<td>From Date : </td>
				<td><?=form_input(array('name' => 'fdate', 'value' => set_value('fdate'), 'id' => 'datepicker1', 'size' => '20', 'maxlength' => '20'))?><?=form_error('fdate')?></td>
			</tr>
			<tr>
				<td>To Date : </td>
				<td><?=form_input(array('name' => 'tdate', 'value' => set_value('tdate'), 'id' => 'datepicker2', 'size' => '20', 'maxlength' => '20'))?><?=form_error('tdate')?></td>
			</tr>
		</table>
	...
	<tr>
		<td>Order Status : </td>
		<td><?=form_dropdown('status_order', array(0 => 'Complete', 1 => 'Incomplete', 10 => 'Both'), set_value('status_order'))?><?=form_error('status_order')?></td>
	</tr>
	<tr>
